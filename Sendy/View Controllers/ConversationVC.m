...
//  Sendy
//
//  Created by Ishan Shikha on 15/08/15.
...
@interface ConversationVC () <UITableViewDelegate, UITableViewDataSource, ChatServiceDelegate>
...
- (void)keyboardWillShow:(NSNotification *)note
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.inputBackgroundView.transform = CGAffineTransformMakeTranslation(0, -keyboardBounds.size.height+49);
