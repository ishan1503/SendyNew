...
-(void)configureTabAtIndex : (NSInteger)index andTitleOrientation : (NMTitleOrientation)titleOrientation withUnselectedBackgroundImage : (UIImage *)backImage selectedBackgroundImage : (UIImage *)selecetedBackImage iconImage : (UIImage *)iconImage iconImageSelected : (UIImage *)iconImageSelected andText : (NSString *)text andTextFont:(UIFont *)font andFontColour:(UIColor *)color{
    ...
    [button setImage:iconImageSelected forState:UIControlStateSelected];
